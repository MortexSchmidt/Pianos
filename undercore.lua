...
local function initTeleportSubmenu()
...
-- SPECTATE / FOLLOW SUBMENU
-- ===================
local function initSpectateSubmenu()
...
end -- initVisualPreview function
initVisualPreview()
...
-- Forward declarations for state variables referenced in resetAllCheats
...
end -- initCombat function
initCombat()

-- MM2 ROLE DETECTION + ESP (wrapped in function for separate register file)
